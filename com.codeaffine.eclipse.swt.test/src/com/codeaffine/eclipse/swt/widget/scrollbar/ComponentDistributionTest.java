...
public class ComponentDistributionTest {
  ...
  public void distributionWithLowestDragPosition() {
    assertThat( new ComponentDistribution( 300, 100, 0, 50 ) )
      .hasUpFastLength( 0 )
      .hasDragStart( 17 )
      .hasDragLength( 133 )
  ...
  public void distributionWithHighestDragPosition() {
    assertThat( new ComponentDistribution( 300, 100, 50, 50 ) )
      .hasUpFastLength( 133 )
      .hasDragStart( 150 )
      .hasDragLength( 133 )
  ...
  public void distributionWithDragPositionInRange() {
    assertThat( new ComponentDistribution( 300, 100, 13, 50 ) )
      .hasUpFastLength( 34 )
      .hasDragStart( 51 )
      .hasDragLength( 133 )
  ...
  public void distributionWithDragRangeOverflow() {
    assertThat( new ComponentDistribution( 300, 10000, 0, 50 ) )
      .hasUpFastLength( 0 )
      .hasDragStart( 17 )
      .hasDragLength( 17 )
      .hasDownFastStart( 34 )
